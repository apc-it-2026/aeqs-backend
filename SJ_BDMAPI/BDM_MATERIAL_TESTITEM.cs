...
namespace SJ_BDMAPI
{
    public class BDM_MATERIAL_TESTITEM
    {
        /// <summary>
        /// 查询-检测项目-材料-测试
        /// </summary>
        ...
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject GetMATERIAL_TESTITEM(object OBJ)
        {
            ...
            try
            {
                ...
                string sql = $@"select ID,INSPECTION_CODE,INSPECTION_NAME,judgment_criteria,STANDARD_VALUE,REMARKS,JUDGE_TYPE from bdm_material_testitem_m where 1=1 {where}";
        ...
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject SaveMATERIAL_TESTITEM(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
            try
            {
                ...
                {
                    int count = DB.GetInt32($@"select count(1) from bdm_material_testitem_m where INSPECTION_CODE='{code}'");
                    if (count > 0)
                    {
                        ret.IsSuccess = false;
                    ...
                    DB.ExecuteNonQuery($@"insert into bdm_material_testitem_m(INSPECTION_CODE,INSPECTION_NAME,judgment_criteria,JUDGE_TYPE,STANDARD_VALUE,REMARKS,CREATEBY,CREATEDATE,CREATETIME)
                                           values('{code}','{name}','{judge}','{judge_type}','{judge_value}','{remark}','{CreactUserId}','{date}','{time}')");
                }
                else
                {
                    DB.ExecuteNonQuery($@"update bdm_material_testitem_m set INSPECTION_NAME='{name}',
        ...
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject DeleteMATERIAL_TESTITEM(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
            try
            {
                ...
                {
                    DB.ExecuteNonQuery($@"delete bdm_material_testitem_m where id in({idlist})");
                }
                DB.Commit();
                ret.IsSuccess = true;
        ...
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject GetMATERIAL_TESTITEM_Custom(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
        ...
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject GetMATERIAL_TESTITEM_Custom_Insert(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
            try
            {
                ...
                sql = $@"SELECT MATERIAL_TYPE_CODE as code,MATERIAL_TYPE_NAME as value FROM bdm_material_type_m";
                ...
                Dictionary<string, object> dic = new Dictionary<string, object>();
                dic.Add("Data1", dt1);//bdm_material_type_m 材料类型
        ...
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject SaveMATERIAL_TESTITEM_Custom_Insert(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
            try
            {
                ...
                //string material_type_code = jarr.ContainsKey("material_type_code") ? jarr["material_type_code"].ToString() : "";//查询条件 种类编号
                //string material_type_name = jarr.ContainsKey("material_type_name") ? jarr["material_type_name"].ToString() : "";//查询条件 种类名称
                ...
                int countNO = DB.GetInt32($@"select count(1) from bdm_material_testitem_c where c_no='{c_no}'");
                if (countNO > 0)
                {
                    ret.IsSuccess = false;
                    ret.ErrMsg = "Number cannot be repeated!";
                ...
                int count = DB.GetInt32($@"select count(1) from bdm_material_testitem_c where fgt_code='{fgt_code}'");
                if (count > 0)
                {
                    ret.IsSuccess = false;
                ...
                string sql = $@"insert into bdm_material_testitem_c 
        ...
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject DeleteMATERIAL_TESTITEM_Custom(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
            try
            {
                ...
                string sql = string.Empty;
                sql = $@"delete from bdm_material_testitem_c where id='{id}'";
                DB.ExecuteNonQuery(sql);
                sql = $@"delete from bdm_material_testitem_u where c_id='{id}'";
                DB.ExecuteNonQuery(sql);
                DB.Commit();
                ret.IsSuccess = true;
        ...
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject GetMATERIAL_TESTITEM_Custom_Check(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
            try
            {
                ...
                string sql = $@"SELECT
                            ...
                            CASE
	                            ...
	                            END AS ischeck 
                            FROM
	                            bdm_material_testitem_m m
	                            LEFT JOIN bdm_material_testitem_u u ON m.id = u.m_id and u.c_id='{cid}'
        ...
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject SaveMATERIAL_TESTITEM_Custom_Check(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
            try
            {
                ...
                foreach (DataRow item in mtable.Rows)
                {
                    ...
                    {
                        int count = DB.GetInt32($@"select count(1) from bdm_material_testitem_u where m_id='{item["mid"]}' and c_id='{cid}'");
                        if (count <= 0)
                        {
                            sql = $@"insert into bdm_material_testitem_u (m_id,c_id,createby,createdate,createtime) 
                    ...
                    {
                        sql = $@"delete from bdm_material_testitem_u where m_id='{item["mid"]}' and c_id='{cid}'";
                        DB.ExecuteNonQuery(sql);
                    }
                }
