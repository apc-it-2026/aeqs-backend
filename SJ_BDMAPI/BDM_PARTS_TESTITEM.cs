...
namespace SJ_BDMAPI
{
    public class BDM_PARTS_TESTITEM
    {
        /// <summary>
        /// 查询-检测项目-部件-测试
        /// </summary>
        ...
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject GetPARTS_TESTITEM(object OBJ)
        {
            ...
            try
            {
                ...
                string sql = $@"select ID,INSPECTION_CODE,INSPECTION_NAME,judgment_criteria,STANDARD_VALUE,REMARKS,JUDGE_TYPE from bdm_parts_testitem_m where 1=1 {where}";
        ...
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject SavePARTS_TESTITEM(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
            try
            {
                ...
                {
                    int count = DB.GetInt32($@"select count(1) from bdm_parts_testitem_m where INSPECTION_CODE='{code}'");
                    if (count > 0)
                    {
                        ret.IsSuccess = false;
                        ret.ErrMsg = $@"Inspection item number cannot be repeated!";
                        return ret;
                    }
                    DB.ExecuteNonQuery($@"insert into bdm_parts_testitem_m(INSPECTION_CODE,INSPECTION_NAME,judgment_criteria,JUDGE_TYPE,STANDARD_VALUE,REMARKS,CREATEBY,CREATEDATE,CREATETIME)
                                           values('{code}','{name}','{judge}','{judge_type}','{judge_value}','{remark}','{CreactUserId}','{date}','{time}')");
                }
                else
                {
                    DB.ExecuteNonQuery($@"update bdm_parts_testitem_m set INSPECTION_NAME='{name}',
        ...
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject DeletePARTS_TESTITEM(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
            try
            {
                ...
                {
                    DB.ExecuteNonQuery($@"delete bdm_parts_testitem_m where id in({idlist})");
                }
                DB.Commit();
                ret.IsSuccess = true;
        ...
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject GetPARTS_TESTITEM_Custom(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
        ...
        /// <summary>
        /// 查询-检测项目-部件-测试-定制类型-新增查询
        /// </summary>
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject GetPARTS_TESTITEM_Custom_Insert(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
            try
            {
                ...
                Dictionary<string, object> dic = new Dictionary<string, object>();
                dic.Add("Data1", dt1);//bdm_parts_m 部件
        ...
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject SavePARTS_TESTITEM_Custom_Insert(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
            try
            {
                ...
                //string parts_code = jarr.ContainsKey("parts_code") ? jarr["parts_code"].ToString() : "";//查询条件 部件编号
                //string parts_name = jarr.ContainsKey("parts_name") ? jarr["parts_name"].ToString() : "";//查询条件 部件名称
                ...
                int countNO = DB.GetInt32($@"select count(1) from bdm_parts_testitem_c where c_no='{c_no}'");
                if (countNO > 0)
                {
                    ret.IsSuccess = false;
                ...
                int count = DB.GetInt32($@"select count(1) from bdm_parts_testitem_c where fgt_code='{fgt_code}'");
                if (count > 0)
                {
                    ret.IsSuccess = false;
                ...
                string sql = $@"insert into bdm_parts_testitem_c 
        ...
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject DeletePARTS_TESTITEM_Custom(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
            try
            {
                ...
                string sql = string.Empty;
                sql = $@"delete from bdm_parts_testitem_c where id='{id}'";
                DB.ExecuteNonQuery(sql);
                sql = $@"delete from bdm_parts_testitem_u where c_id='{id}'";
                DB.ExecuteNonQuery(sql);
                DB.Commit();
                ret.IsSuccess = true;
        ...
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject GetPARTS_TESTITEM_Custom_Check(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
            try
            {
                ...
                string sql = $@"SELECT
                            ...
                            CASE
	                            ...
	                            END AS ischeck 
                            FROM
	                            bdm_parts_testitem_m m
	                            LEFT JOIN bdm_parts_testitem_u u ON m.id = u.m_id and u.c_id='{cid}'
        ...
        /// <summary>
        /// 保存-检测项目-部件-测试-定制类型-勾选
        /// </summary>
        /// <param name="OBJ"></param>
        /// <returns></returns>
        public static SJeMES_Framework_NETCore.WebAPI.ResultObject SavePARTS_TESTITEM_Custom_Check(object OBJ)
        {
            SJeMES_Framework_NETCore.WebAPI.RequestObject ReqObj = (SJeMES_Framework_NETCore.WebAPI.RequestObject)OBJ;
            SJeMES_Framework_NETCore.WebAPI.ResultObject ret = new SJeMES_Framework_NETCore.WebAPI.ResultObject();
            SJeMES_Framework_NETCore.DBHelper.DataBase DB = new SJeMES_Framework_NETCore.DBHelper.DataBase();
            try
            {
                ...
                foreach (DataRow item in mtable.Rows)
                {
                    ...
                    {
                        int count = DB.GetInt32($@"select count(1) from bdm_parts_testitem_u where m_id='{item["mid"]}' and c_id='{cid}'");
                        if (count <= 0)
                        {
                            sql = $@"insert into bdm_parts_testitem_u (m_id,c_id,createby,createdate,createtime) 
                    ...
                    {
                        sql = $@"delete from bdm_parts_testitem_u where m_id='{item["mid"]}' and c_id='{cid}'";
                        DB.ExecuteNonQuery(sql);
                    }
                }
